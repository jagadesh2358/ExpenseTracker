            ...
            if (expenseManager != null && isAuthenticated) {
                while (true) {
                    ...
                    switch (menuChoice) {
                        ...
                        case 2:
                            // View Expenses
//                        	List<Expense> loadedExpenses=FileHandler.loadExpenses("expenses.txt");
                            List<Expense> expenses = expenseManager.listExpenses();
//                            System.out.println(loadedExpenses);
                            System.out.println("Expenses: " + expenses);
                            System.out.println(expenseManager.getCategoryWiseSummation());
                            break;
                        case 3:
...
//                            break;
                        	...
                        	FileHandler.saveExpenses(expenseManager.listExpenses(), "expenses_" + loginUsername + ".txt");
                            System.out.println("Expenses saved to file.");
                            break;
                        case 4:
                            exit = true;
